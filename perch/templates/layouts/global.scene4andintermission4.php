...
<!-- Storyboard:
	...
	6.
-->
<div class="scene part4" id="scene4"> <!-- Part 4 -->
	<div class="body-gradient-flood gradient-4">
		<div class="scene-container night"
			...
			<div class="contact">
				...
				<div class="eight columns contact-form">
					...
					<div class="mc-field-group">
						...
						<input type="text" value="" name="MESSAGE" class="message" id="mce-MESSAGE">
					</div>
					...
					function mce_init_form(){
					    jQuery(document).ready( function($) {
					      ...
					      options = { url: 'http://emmachee.us6.list-manage2.com/subscribe/post-json?u=e012a3ed241e30c1824ba75a6&id=fc942f19c0&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
