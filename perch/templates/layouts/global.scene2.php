<div id="scene2" class="scene part2 gradient-2"> <!-- Part 2 -->
	...
	data--5000-top		= "width:-10%; box-shadow: -20px 0px 20px 0px rgba(0,0,0,0.5);">
		...
		data-1000-bottom	= "filter: blur(1px); transform: translate3d(-12%, -26%, 0) scale(0.55);"
		...
		data-anchor-target 	= "#scene2"
		data-0-top			= "display:!block; opacity: 1.0; transform: translate3d(15%, -28%, 0) scale(0.8);"
		...
		data-1000-bottom	= "filter: blur(5px); transform: translate3d(15%, -31%, 0) scale(0.6);"
