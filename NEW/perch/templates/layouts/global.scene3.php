<div id="scene3" class="scene part3  gradient-3"> <!-- Part 3 -->
	<div class="body-gradient-flood centered alley">
		<div class="scene-layer alley-master"
			...
			data--1000-top		= "opacity: 1.0; transform: scale(1.0);"
			data-1000-bottom	= "position:!fixed; bottom:0px; background-position: 0px 100px;"
			data--300-bottom		= "position:fixed; bottom:0px"
			data--1000-bottom	= "bottom:1000px"
