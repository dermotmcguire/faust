...
<body>
	...
	<div class="intermission"  id="intermission-4"> <!-- Intermission 4 -->
		<div class="last-intermission-bg">
			...
			<div class="container">
				...
				<div class="sixteen columns information-text" id="newsflash">
					<?php perch_content('Newsflash'); ?>
				</div>
				<div class="sixteen columns information-text" id="thearchives">
					<?php perch_content('The Archives'); ?>
				</div>
				</div>
				<div class="clear"></div>
			</div> <!-- end container -->
		</div>
	</div><!-- End Intermission 4 -->
